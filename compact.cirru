...
{} (:about "|file is generated - never edit directly; learn cr edit/tree workflows before changing") (:package |app)
  ...
  :files $ {}
    ...
    |app.comp.kaleidoscope $ %{} :FileEntry
      :defs $ {}
        |comp-kaleidoscope $ %{} :CodeEntry (:doc |) (:schema nil)
          :code $ quote
          ...
          :examples $ []
        |file-image $ %{} :CodeEntry (:doc |) (:schema nil)
          :code $ quote
    ...
    |app.comp.navbar $ %{} :FileEntry
      :defs $ {}
        |comp-help-menu $ %{} :CodeEntry (:doc |) (:schema nil)
          :code $ quote
        ...
        |comp-navbar $ %{} :CodeEntry (:doc |) (:schema nil)
          ...
          :examples $ []
        |inline-file $ %{} :CodeEntry (:doc |) (:schema nil)
          :code $ quote
    ...
    |app.config $ %{} :FileEntry
      :defs $ {}
        |inline-shader $ %{} :CodeEntry (:doc |) (:schema nil)
          :code $ quote
